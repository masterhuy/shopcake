...
@section('content')
	<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">{{ trans('home.giới thiệu') }}</h6>
			</div>
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="">{{ trans('home.trang chủ') }}</a> / <span>{{ trans('home.giới thiệu') }}</span>
				</div>
			</div>
	...
	<div class="container">
		<div id="content">
			...
			<hr />
			<div class="space50">&nbsp;</div>
			<h2 class="text-center wow fadeInDown">{{  trans('home.niềm đam mê của chúng tôi với những gì chúng tôi chuyển đến dịch vụ của chúng tôi') }}</h2>
			<div class="space20">&nbsp;</div>
			<p class="text-center wow fadeInLeft">{{ trans('home.chúng tôi sẽ tích cực phát triển hơn nữa để đem đến những sản phẩm tốt nhất cho khách hàng') }}. </p>
			<div class="space35">&nbsp;</div>
			...
			<div class="row">
				<div class="col-sm-2 col-sm-push-2">
					<div class="beta-counter">
						...
						<p class="beta-counter-title">{{ trans('home.hài lòng') }}</p>
					</div>
				</div>
				...
				<div class="col-sm-2 col-sm-push-2">
					<div class="beta-counter">
						...
						<p class="beta-counter-title">{{ trans('home.tuyệt vời') }}</p>
					</div>
				</div>
				...
				<div class="col-sm-2 col-sm-push-2">
					<div class="beta-counter">
						...
						<p class="beta-counter-title">{{ trans('home.ủng hộ') }}</p>
					</div>
				</div>
				...
				<div class="col-sm-2 col-sm-push-2">
					<div class="beta-counter">
						...
						<p class="beta-counter-title">{{ trans('home.dự án mới') }}</p>
					</div>
				</div>
